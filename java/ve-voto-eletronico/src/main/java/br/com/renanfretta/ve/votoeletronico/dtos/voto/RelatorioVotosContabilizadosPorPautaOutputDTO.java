...
@Builder
@Entity
public class RelatorioVotosContabilizadosPorPautaOutputDTO implements Serializable {
	...
	@QueryProjection
	public RelatorioVotosContabilizadosPorPautaOutputDTO(Boolean voto, Long totalVotos, PautaOutputDTO pauta) {
		this.voto = voto;
